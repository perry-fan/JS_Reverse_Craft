...
function timing() {
    ...
    var tim = {
        ...
        "domComplete": now + 310,
        "navigationStart": now + 10,
        "loadEventStart": now + 330,
        "domContentLoadedEventEnd": now + 280,
        "unloadEventStart": now + 210,
        "redirectEnd": 0,
        "domInteractive": now + 310,
        "fetchStart": now,
        "domContentLoadedEventStart": now + 310
    }
    return tim;
}
    ...
    for (; $_DAJEI !== mwbxQ.$_DW()[0][11];) {
        switch ($_DAJEI) {
            case mwbxQ.$_DW()[6][13]:
                ...
                break;
            case mwbxQ.$_DW()[0][12]:
                for (var l = (e = e[$_CJES(187)](0, -2))[$_CJFt(192)]; i < l; i++) c[s = e[$_CJES(125)](i)] || (c[s] = 1, _[u][$_CJES(137)](s), u = 5 == ++u ? 0 : u);
                var h,
                    f = a,
                    d = 4,
                    p = $_CJFt(2),
                    g = [1, 2, 5, 10, 50];
                while (0 < f) 0 <= f - g[d] ? (h = parseInt(Math[$_CJFt(21)]() * _[d][$_CJFt(192)], 10), p += _[d][h], f -= g[d]) : (_[$_CJES(115)](d, 1), g[$_CJES(115)](d, 1), d -= 1);
                return p;
                break;
        }
    }
...
var U = function () {
    ...
    if (null == i) {
        ...
        var _ = 0,
            c = function (t) {
                ...
                $_ICDA.shift();
                var $_ICGW = $_ICDA[0];
                if (256 <= (_ = _ || 0) || s <= o) window[$_ICFi(230)] ? (_ = 0, window[$_ICEJ(230)]($_ICFi(268), c, !1)) : window[$_ICFi(235)] && (_ = 0, window[$_ICEJ(235)]($_ICFi(295), c)); else try {
    ...
    return m[$_IAJA(236)][$_IBAP(342)] = function O(t) {
        ...
        while (0 <= --o) {
            ...
            _ < 0 ? $_JBEX(78) == t[$_JBEX(125)](o) && (s = !0) : (s = !1, 0 == a ? this[this[$_JBFs(376)]++] = _ : a + n > this[$_JBEX(349)] ? (this[this[$_JBFs(376)] - 1] |= (_ & (1 << this[$_JBEX(349)] - a) - 1) << a, this[this[$_JBFs(376)]++] = _ >> this[$_JBFs(349)] - a) : this[this[$_JBEX(376)] - 1] |= _ << a, (a += n) >= this[$_JBFs(349)] && (a -= this[$_JBEX(349)]));
        }
        ...
        for (n = 0; n < e[$_JFEW(376)] - 1; ++n) {
            ...
            (t[n + e[$_JFFj(376)]] += e[$_JFFj(301)](n + 1, 2 * e[n], t, 2 * n + 1, r, e[$_JFEW(376)] - n - 1)) >= e[$_JFFj(380)] && (t[n + e[$_JFFj(376)]] -= e[$_JFEW(380)], t[n + e[$_JFEW(376)] + 1] = 1);
        }
        ...
        if (!(r[$_JGAb(376)] <= 0)) {
            ...
            0 < _ ? (r[$_JGAb(305)](_, o), i[$_JFJK(305)](_, n)) : (r[$_JFJK(340)](o), i[$_JGAb(340)](n));
            var c = o[$_JGAb(376)],
                u = o[c - 1];
            if (0 != u) {
        ...
        if (0 < s--) {
            a < this[$_JIAb(349)] && 0 < (n = this[s] >> a) && (i = !0, o = g(n));
            while (0 <= s) {
        ...
        var $_BABBv = $_BAAIs[0];
        var n;
        return n = t < 256 || e[$_BAAJQ(303)]() ? new m(e) : new x(e), this[$_BABAU(369)](t, n);
        ...
        null != t && null != e && 0 < t[$_BACAx(192)] && 0 < e[$_BABJr(192)] ? (this[$_BACAx(334)] = function n(t, e) {
            ...
            var $_BACGl = $_BACDg[0];
            return new y(t, e);
        }(t, 16), this[$_BABJr(390)] = parseInt(e, 16)) : console && console[$_BACAx(32)] && console[$_BACAx(32)]($_BABJr(330));
    ...
    var t,
        ...
        i = r[$_BAEAV(366)] = {
            ...
            "mixIn": function (t) {
                ...
                $_BAHDx.shift();
                var $_BAHGn = $_BAHDx[0];
                for (var e in t) t[$_BAHFJ(75)](e) && (this[e] = t[e]);
        ...
        g = r[$_BADJt(449)] = c[$_BADJt(362)]({
            ...
            "reset": function () {
                ...
                this[$_BBIAo(426)] && this[$_BBHJV(426)][$_BBIAo(471)] == r ? this[$_BBHJV(426)][$_BBHJV(244)](this, e && e[$_BBHJV(389)]) : (this[$_BBHJV(426)] = r[$_BBIAo(318)](n, this, e && e[$_BBIAo(389)]), this[$_BBIAo(426)][$_BBHJV(471)] = r);
            },
            "$_HHA": function (t, e) {
...
var m = {
    ...
    "$_FCD": function (t, i) {
        ...
        for (var e = function (t, e) {
            ...
            $_GEIy.shift();
            var $_GFBR = $_GEIy[0];
            for (var n = 0, r = i[$_GEJI(289)] - 1; 0 <= r; r -= 1) 1 === o[$_GFAZ(237)](e, r) && (n = (n << 1) + o[$_GFAZ(237)](t, r));
            return n;
            ...
            if (a + 2 < s) {
                ...
                var c = s % 3;
                2 == c ? (_ = (t[a] << 16) + (t[a + 1] << 8), n += o[$_GEFH(264)](e(_, i[$_GEFH(238)])) + o[$_GEED(264)](e(_, i[$_GEED(212)])) + o[$_GEED(264)](e(_, i[$_GEED(226)])), r = i[$_GEED(265)]) : 1 == c && (_ = t[a] << 16, n += o[$_GEED(264)](e(_, i[$_GEED(238)])) + o[$_GEED(264)](e(_, i[$_GEED(212)])), r = i[$_GEFH(265)] + i[$_GEED(265)]);
            }
        }
        return {
            "res": n,
    ...
    "$_FFQ": function (t, o) {
        ...
        for (var e = function (t, e) {
            ...
            var $_GHBf = $_GGIO[0];
            if (t < 0) return 0;
            for (var n = 5, r = 0, i = o[$_GHAf(289)] - 1; 0 <= i; i -= 1) 1 === s[$_GGJX(237)](e, i) && (r += s[$_GGJX(237)](t, n) << i, n -= 1);
            return r;
...
//调用
function get_userresponse(t, challenge) {
    let userresponse = H(t, challenge)
    return userresponse;
}

function get_o(distance, challenge, pass_time, trace, c, s, rp2) {
    var aa = W['prototype']['$_BBED'](W['prototype']['$_FD_'](trace), c, s);
    console.log("aa：", aa);
    ep = {
        "v": '7.9.2',
        "$_BIE": false,
...
function get_w3(gt2, challenge2, random_str, distance, pass_time, trace, c, s, rp2) {
    let u = new U()["encrypt"](random_str);
    let param = get_o(distance, challenge2, pass_time, trace, c, s, rp2);
...
module.exports.get_w3 = get_w3;


// gt2 = '019924a82c70bb123aae90d483087f94'
// challenge2 = '04dee19b161858c7edc00855f96be6aehf'
// random_str = '6eb2a1717059c3c8'
// trace = [[-18, -20, 0], [0, 0, 0], [0, 0, 4], [1, -1, 12], [2, -1, 20], [4, -3, 27], [5, -3, 34], [10, -4, 43], [11, -5, 50], [14, -5, 58], [16, -5, 65], [22, -6, 72], [26, -6, 79], [37, -7, 88], [69, -7, 112], [82, -7, 117], [95, -7, 124], [99, -7, 132], [107, -7, 139], [113, -7, 147], [115, -7, 155], [116, -7, 163], [116, -7, 170], [117, -7, 177], [119, -7, 229], [120, -6, 229], [125, -6, 237], [127, -6, 246], [133, -5, 252], [136, -5, 260], [142, -4, 267], [143, -4, 274], [146, -4, 282], [146, -4, 289], [148, -4, 297], [147, -4, 591], [146, -4, 598], [146, -4, 649], [145, -5, 695], [145, -5, 739], [143, -5, 784], [143, -5, 897]]
// c = [12, 58, 98, 36, 43, 95, 62, 15, 12]
// s = '584b5f76'
// rp2 = "61ffbcd8bfd383d87c6911908a0b034b"
// console.log(get_w3(gt2, challenge2, random_str, 194, 897, trace, c, s, rp2))
