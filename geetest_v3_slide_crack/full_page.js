...
!function () {
    !function (e, t) {
        ...
        var $_CJFc = $_CJCU[0];
        "use strict";
        $_CJEf(9) == typeof module && $_CJDi(9) == typeof module[$_CJDi(68)] ?
            true ? t(e, true) : function (e) {
                ...
                i[$_CFEDF(1121)] = function l() {
                    ...
                    return function (e) {
                        ...
                        !function o(e, t) {
                            ...
                            100 < (new Date)[$_CFGEW(208)]() - t[$_CFGDd(208)]() && (e = $_CFGEW(1138)), r = $_CFGEW(730) + i[$_CFGDd(1135)] + $_CFGDd(1136) + n(o[$_CFGDd(66)]() + n(n[$_CFGDd(66)]()) + n(e[$_CFGEW(66)]())) + $_CFGDd(1190);
...
function get_w1(gt, challenge, random_str) {
    let enc = new window.my_X;
    const r = enc.encrypt(random_str);
    let param = {
        "gt": "019924a82c70bb123aae90d483087f94",
        "challenge": "cb36773a7163748d7a475bfa40f31a3c",
        "offline": false,
        "new_captcha": true,
        "product": "float",
        "width": "300px",
    ...
    let o = new window.my_$_BFr().encrypt1(JSON.stringify(param), random_str);
    let i = window.my_p["$_HEG"](o);
    let w = i + r;
    return w;
}
...
function get_w2(rp, random_str) {
    let params = {
        "lang": "zh-cn",
        "type": "fullpage",
        "tt": "M*K8Pj-?M*AU((((/.-Acn)B-g(UKCV1KCNdN9MLjK/0M9oN)q-@9bb200M9nRCj(AM,(,bb5WZ*6U3,1?(E9(bE-)ME(M/*MK()j(MP(,5(5((b55:jU-)1?-1-)*)(9-**)(?-*-MM9-),)(9/)(((/",
        "light": "DIV_0",
        ...
        "ep": {
            ...
            "fp": ["move", 683, 286, 1733908423892, "pointermove"],
            "lp": ["up", 712, 311, 1733908424802, "pointerup"],
            "em": {
                "ph": 0,
                "cp": 0,
                "ek": "11",
    ...
    let r = JSON.stringify(params);
    let enc_res = window.my_$_BFr().encrypt(r, random_str)
    let w = window.my_p["$_HEG"](enc_res);
    return w;
}
