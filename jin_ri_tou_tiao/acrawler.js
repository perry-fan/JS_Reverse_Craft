        ...
        if (typeof window[name] !== 'undefined') {
            proxyObjects[name] = new Proxy(window[name], {
                get(target, prop, receiver) {
                    ...
                    console.log(`方法：GET | 对象：${name} | 属性名：${String(prop)}| 属性类型：${typeof prop} | 属性值类型：${typeof value}`);
                    return value;
                },
                set(target, prop, value, receiver) {
                    console.log(`方法：SET | 对象：${name} | 属性名：${String(prop)} | 属性值类型：${typeof value}`);
            ...
            Object.defineProperty(window, name, {
                ...
                set: (val) => {
                    console.log(`方法：SET | 对象：window | 属性名：${name} |  属性值类型：${typeof val}`);
...
document.cookie = "gfkadpd=24,6457; x-web-secsdk-uid=b7080d7e-ec09-47b2-8898-b6882a4d02af; s_v_web_id=verify_m6m9wao0_YU1rxIeB_5CqJ_4PVz_A0rM_xfy1XfNTV2SL; _ga=GA1.1.704578180.1738419183; local_city_cache=%E7%A7%A6%E7%9A%87%E5%B2%9B; csrftoken=0f4df955bf18a532021aca8715a3c8ac; tt_scid=zS3UYrLre652ClPYVEemzZ342in3E-L96wPrFMKpl-hJk0vOLJnZHZhAc6T6Y1eYfd37; _ga_QEHZPBE5HH=GS1.1.1738419183.1.1.1738422259.0.0.0"
url = {"url": 'https://www.toutiao.com/hot-event/hot-board/?origin=toutiao_pc'}
var res = window.byted_acrawler.sign(url)
console.log(res)